...
namespace task2._3._3
{
    class Program
    {
        static void Main(string[] args)
        {
            FileInfo outFile = new FileInfo(@"D:/Google Drive/PoW2019/Do oddania/out.txt");
            using (AesCryptoServiceProvider aes = new AesCryptoServiceProvider())
            {
                // Encryption
                string text = File.ReadAllText(@"D:/Google Drive/PoW2019/Do oddania/log.txt");
