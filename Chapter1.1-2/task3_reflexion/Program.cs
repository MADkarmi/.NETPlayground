...
namespace task3_reflexion
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Reflection ADD - ElapsedTime: {0}", elapsed);
            ...
            elapsed = end - start;
            Console.WriteLine("Reflection Property - ElapsedTime: {0}", elapsed);
    ...
    class Class
    {
        ...
        public void RunAdd(int a, int b, int times)
        {
            ...
            DateTime end = DateTime.Now;
            TimeSpan elapsed = end - start;
            Console.WriteLine("RunAdd - ElapsedTime: {0}", elapsed);
        }
